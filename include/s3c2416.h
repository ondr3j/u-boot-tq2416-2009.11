...
#define CLKDIV2CON_REG		__REG(0x4c00002c)
...
#define DSC3_REG			__REG(0x56000110)
...
#define rNFCONF_REG			__REG(0x4E000000)		//NAND Flash configuration
#define rNFCONT_REG			__REG(0x4E000004)		//NAND Flash control
#define rNFCMD_REG			__REG(0x4E000008)		//NAND Flash command
#define rNFADDR_REG			__REG(0x4E00000C)		//NAND Flash address
#define rNFDATA_REG			__REG(0x4E000010)		//NAND Flash data
#define rNFDATA8_REG		__REGb(0x4E000010)		//NAND Flash data
#define rNFMECCD0_REG		__REG(0x4E000014)		//NAND Flash ECC for Main Area
#define rNFMECCD1_REG		__REG(0x4E000018)
#define rNFSECCD_REG		__REG(0x4E00001C)		//NAND Flash ECC for Spare Area
#define rNFSBLK_REG			__REG(0x4E000020)		//NAND Flash programmable start block address register
#define rNFEBLK_REG			__REG(0x4E000024)		//NAND Flash programmable start block address register
#define rNFSTAT_REG			__REG(0x4E000028)		//NAND Flash operation status
#define rNFECCERR0_REG		__REG(0x4E00002C)		//NAND Flash ECC error status0
#define rNFECCERR1_REG		__REG(0x4E000030)		//NAND Flash ECC error status1
#define rNFMECC0_REG		__REG(0x4E000034)
#define rNFMECC1_REG		__REG(0x4E000038)
#define rNFSECC_REG			__REG(0x4E00003C)
#define rNFMLCBITPT_REG		__REG(0x4E000040)
#define rNF8ECCERR0_REG		__REG(0x4E000044)
#define rNF8ECCERR1_REG		__REG(0x4E000048)
#define rNF8ECCERR2_REG		__REG(0x4E00004C)
#define rNFM8ECC0_REG		__REG(0x4E000050)
#define rNFM8ECC1_REG		__REG(0x4E000054)
#define rNFM8ECC2_REG		__REG(0x4E000058)
#define rNFM8ECC3_REG		__REG(0x4E00005C)
#define rNFMLC8BITPT0_REG	__REG(0x4E000060)
#define rNFMLC8BITPT1_REG	__REG(0x4E000064)
...
#define HM_TRNMOD_REG		__REG(HM_TRNMOD)
#define HM_CLKCON_REG		__REG(HM_CLKCON)
#define HM_CONTROL2_REG		__REG(HM_CONTROL2)
#define HM_CONTROL3_REG		__REG(HM_CONTROL3)
#define HM_CONTROL4_REG		__REG(HM_CONTROL4)
/*
...
typedef volatile u8	S3C2416_REG8;
typedef volatile u16 S3C2416_REG16;
typedef volatile u32 S3C2416_REG32;

/* LCD CONTROLLER */
typedef struct {
	volatile u32	v_VIDCON0;
	volatile u32	v_VIDCON1;
	volatile u32	v_VIDTCON0;
	volatile u32	v_VIDTCON1;
	volatile u32	v_VIDTCON2;
	volatile u32	v_WINCON0;
	volatile u32	v_WINCON1;
	volatile u8		reg0[12];
	volatile u32	v_VIDOSD0A;
	volatile u32	v_VIDOSD0B;
	volatile u8		reg1[4];
	volatile u32	v_VIDOSD1A;
	volatile u32	v_VIDOSD1B;
	volatile u32	v_VIDOSD1C;
	volatile u8		reg2[36];
	volatile u32	v_VIDW00ADD0B0;
	volatile u32	v_VIDW00ADD0B1;
	volatile u32	v_VIDW01ADD0;
	volatile u8		reg3[12];
	volatile u32	v_VIDW00ADD1B0;
	volatile u32	v_VIDW00ADD1B1;
	volatile u32	v_VIDW01ADD1;
	volatile u8		reg4[12];
	volatile u32	v_VIDW00ADD2B0;
	volatile u32	v_VIDW00ADD2B1;
	volatile u32	v_VIDW01ADD2;
	volatile u8		reg5[12];
	volatile u32	v_VIDINTCON;
	volatile u32	v_W1KEYCON0;
	volatile u32	v_W1KEYCON1;
	volatile u32	v_W2KEYCON0;
	volatile u32	v_W2KEYCON1;
	volatile u32	v_W3KEYCON0;
	volatile u32	v_W3KEYCON1;
	volatile u32	v_W4KEYCON0;
	volatile u32	v_W4KEYCON1;
	volatile u32	v_WIN0MAP;
	volatile u32	v_WIN1MAP;
	volatile u8		reg6[12];
	volatile u32	v_WPALCON;
	volatile u8		reg7[72];
	volatile u32	v_SYSIFCON0;
	volatile u32	v_DITHMODE;
	volatile u32	v_SIFCCON0;
	volatile u32	v_SIFCCON1;
	volatile u32	v_SIFCCON2;
	volatile u8		reg8[24];
	volatile u32	v_CPUTRIGCON2;
} /*__attribute__((__packed__))*/ S3C2416_LCD;

/* GPIO CONTROLLER */
typedef struct {
	volatile u32	g_GPACON;
	volatile u32	g_GPADAT;
	volatile u8		reg1[4];
	volatile u8		reg2[4];

	volatile u32	g_GPBCON;
	volatile u16	g_GPBDAT;
	volatile u8		reg3[2];
	volatile u32	g_GPBUDP;
	volatile u8		g_GPBSEL;
	volatile u8		reg4[3];
	
	volatile u32	g_GPCCON;
	volatile u16	g_GPCDAT;
	volatile u8		reg5[2];
	volatile u32	g_GPCUDP;
	volatile u8		reg6[4];
	
	volatile u32	g_GPDCON;
	volatile u16	g_GPDDAT;
	volatile u8		reg7[2];
	volatile u32	g_GPDUDP;
	volatile u8		reg8[4];
	
	volatile u32	g_GPECON;
	volatile u16	g_GPEDAT;
	volatile u8		reg9[2];
	volatile u32	g_GPEUDP;
	volatile u8		g_GPESEL;
	volatile u8		reg10[3];
	
	volatile u16	g_GPFCON;
	volatile u8		reg11[2];
	volatile u8		g_GPFDAT;
	volatile u8		reg12[3];
	volatile u16	g_GPFUDP;
	volatile u8		reg13[6];
	
	volatile u16	g_GPGCON;
	volatile u8		reg14[2];
	volatile u8		g_GPGDAT;
	volatile u8		reg15[3];
	volatile u16	g_GPGUDP;
	volatile u8		reg16[6];
	
	volatile u32	g_GPHCON;
	volatile u16	g_GPHDAT;
	volatile u8		reg17[2];
	volatile u32	g_GPHUDP;
	volatile u8		reg18[28];	//
	
	volatile u32	g_GPKCON;
	volatile u16	g_GPKDAT;
	volatile u8		reg19[2];
	volatile u32	g_GPKUDP;
	volatile u8		reg20[4];
	
	volatile u32	g_GPLCON;
	volatile u16	g_GPLDAT;
	volatile u8		reg21[2];
	volatile u32	g_GPLUDP;
	volatile u8		reg22[4];
	
	volatile u8		g_GPMCON;
	volatile u8		reg23[3];
	volatile u8		g_GPMDAT;
	volatile u8		reg24[3];
	volatile u8		g_GPMUDP;
	volatile u8		reg25[7];
	

} /*__attribute__((__packed__))*/ S3C2416_GPIO;

/* NAND CONTROLLER */
typedef struct {
	volatile u32	n_NFCONF;			//0x00
	volatile u32	n_NFCONT;			//0x04
	volatile u8		n_NFCMD;			//0x08
	volatile u8		reg1[3];
	volatile u32	n_NFADDR;			//0x0C
	volatile u8		reg2[3];
	volatile u8		n_NFDATA;			//0x10
	volatile u8		reg3[3];
	volatile u32	n_NFMECCD0;			//0x14
	volatile u32	n_NFMECCD1;			//0x18
	volatile u32	n_NFSECCD;			//0x1C
	volatile u32	n_NFSBLK;			//0x20
	volatile u32	n_NFEBLK;			//0x24
	volatile u8		n_NFSTAT;			//0x28
	volatile u8		reg4[3];
	volatile u32	n_NFECCERR0;		//0x2C
	volatile u32	n_NFECCERR1;		//0x30
	volatile u32	n_NFMECC0;			//0x34
	volatile u32	n_NFMECC1;			//0x38
	volatile u32	n_NFSECC;			//0x3C
	volatile u32	n_NFMLCBITPT;		//0x40
	volatile u32	n_NF8ECCERR0;		//0x44
	volatile u32	n_NF8ECCERR1;		//0x48
	volatile u32	n_NF8ECCERR2;		//0x4C
	volatile u32	n_NFM8ECC0;			//0x50
	volatile u32	n_NFM8ECC1;			//0x54
	volatile u32	n_NFM8ECC2;			//0x58
	volatile u32	n_NFM8ECC3;			//0x5C
	volatile u32	n_NFMLC8BITPT0;		//0x60
	volatile u32	n_NFMLC8BITPT1;		//0x64
} /*__attribute__((__packed__))*/ S3C2416_NAND;

static inline S3C2416_LCD * S3C2416_GetBase_LCD(void)
{
	return (S3C2416_LCD *)ELFIN_LCD_BASE;
}
static inline S3C2416_GPIO * S3C2416_GetBase_GPIO(void)
{
	return (S3C2416_GPIO *)ELFIN_GPIO_BASE;
}
static inline S3C2416_NAND * S3C2416_GetBase_NAND(void)
{
	return (S3C2416_NAND *)ELFIN_NAND_BASE;
}
