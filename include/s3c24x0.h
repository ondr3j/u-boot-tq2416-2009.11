...
typedef struct s3c24x0_usb_host {
...
typedef struct s3c24x0_interrupt {
...
typedef struct s3c24x0_timer {
	S3C24X0_REG32	TCNTB;
	S3C24X0_REG32	TCMPB;
	S3C24X0_REG32	TCNTO;
}S3C24x0_TIMER;

typedef struct s3c24x0_timers {
	S3C24X0_REG32		TCFG0;
	S3C24X0_REG32		TCFG1;
	S3C24X0_REG32		TCON;
...
typedef struct s3c24x0_usb_device {
#ifdef __BIG_ENDIAN
	S3C24X0_REG8	res1[3];
...
typedef struct s3c24x0_watchdog {
	S3C24X0_REG32	WTCON;
	S3C24X0_REG32	WTDAT;
	S3C24X0_REG32	WTCNT;
}S3C24X0_WATCHDOG;
