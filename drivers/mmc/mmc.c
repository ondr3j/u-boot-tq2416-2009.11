...
ulong sd_movi_write(ulong start, lbaint_t blkcnt, void *src)
{
	return mmc_bwrite(0, start, blkcnt, src);
}

ulong sd_movi_read(ulong start, lbaint_t blkcnt, void *dst)
{
...
block_dev_desc_t *sd_mmc_get_dev(int dev)
{
...
int sd_mmc_init(struct mmc *host)
{
	int err;
