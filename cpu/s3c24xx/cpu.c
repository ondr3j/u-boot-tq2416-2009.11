...
int cpu_init (void)
{
	...
	IRQ_STACK_START = _armboot_start + CONFIG_UBOOT_SIZE - CONFIG_MALLOC_LEN - CONFIG_STACK_SIZE - 4;
#else
	IRQ_STACK_START = _armboot_start - CONFIG_MALLOC_LEN - CONFIG_GBL_DATA_SIZE - 4;
#endif
